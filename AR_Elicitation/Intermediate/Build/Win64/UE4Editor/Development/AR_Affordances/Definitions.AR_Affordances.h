...
#define ORIGINAL_FILE_NAME "UE4Editor-AR_Affordances.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_PROJECT_NAME AR_Affordances
...
#define AR_AFFORDANCES_API DLLEXPORT
