...
#define ORIGINAL_FILE_NAME "UE4Editor-AR_Elicitation.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_PROJECT_NAME AR_Elicitation
...
#define AR_ELICITATION_API DLLEXPORT
